...
| --- | --- | --- | --- |
| Codex | `~/.codex/skills/legacy-impact-audit` or `$CODEX_HOME/skills/legacy-impact-audit` | Not used by this kit | Native Codex skill plus `~/.codex/AGENTS.md`; no Codex startup hook required. |
